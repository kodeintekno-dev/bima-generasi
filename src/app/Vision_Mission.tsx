    ...
    <section className="bg-sky-50 py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Visi */}
          <div className="bg-sky-100 rounded-xl px-10 py-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-gray-600 text-base md:text-xl max-w-sm">
          ...
          {/* Misi */}
          <div className="bg-sky-100 rounded-xl px-10 py-12">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full bg-[#024A71] flex items-center justify-center">
                <CheckCircle className="text-white" size={22} />
              </div>

              <h3 className="text-xl md:text-3xl lg:text-4xl font-bold text-[#024A71]">
                Misi Kami
              </h3>
            </div>

            <ol className="list-decimal list-inside space-y-3 text-gray-700 text-base md:text-xl">
              <li>
